...
const menuData = [
  ...
  // ---------------------------------------------------------------
  // المكاشات — served as a plate, no bread/wrap
  // ---------------------------------------------------------------
  {
    id: "cat-majash",
    category: "المكاشات",
    ...
    layout: "cards",
    items: [
      { name: "ماجاش كبير شنيتسل", price: 45, desc: "شنيتسل مقرمش يُقدَّم مع خضار وصوصات في وجبة عائلية كبيرة." },
      { name: "ماجاش كبير مسحب", price: 45, desc: "دجاج مسحب متبل يُقدَّم مع خضار وصوصات في وجبة عائلية كبيرة." },
      { name: "ماجناش برجيت", price: 45, desc: "شاورما برجيت الدجاج تُقدَّم مع خضار وصوصات في وجبة عائلية كبيرة." }
    ]
  },
