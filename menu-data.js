...
const menuData = [
  ...
  // ---------------------------------------------------------------
  {
    ...
    layout: "cards",
    items: [
      { name: "كرسبي برجر", price: 20, desc: "قطعة دجاج مقرمشة مع خس طازج وصوص خاص في خبز طري." },
      { name: "برجر لحمة", price: 25, desc: "قرص لحم مشوي طازج مع جبنة ذائبة وصوص البيت." },
      { name: "برجر ستيك جاج مشوي", price: 18, desc: "شرائح صدر دجاج مشوية على القريل مع خس وصوص خاص في خبز طري." },
  ...
  // ---------------------------------------------------------------
  {
    ...
    items: [
      ...
      { name: "باجيت شنيتسل حار", price: 17, desc: "شنيتسل حار مقرمش بتتبيلة مميزة داخل باجيت." },
      { name: "باجيت برجيت", price: 17, desc: "شاورما دجاج بالتتبيلة الخاصة داخل خبز باجيت طازج." },
      { name: "باجيت مسحب", price: 17, desc: "دجاج مسحب متبل مع الخضار داخل باجيت." },
      { name: "باجيت ستيك جاج", price: 17, desc: "شرائح صدر دجاج مشوية على القريل مع خضار طازجة." },
      { name: "معراف", price: 17, desc: "جاج وكبدة دجاج متبلة ومشوية مع خضار وصوص داخل خبز باجيت طازج." },
  ...
  // ---------------------------------------------------------------
  {
    ...
    layout: "cards",
    items: [
      { name: "سلطة السيزر مع جاج", price: 25, desc: "خس روماني مع دجاج مشوي، بندورة شيري وجبنة بارميزان مع صوص السيزر." },
      ...
      { name: "جرين فريش", price: 25, desc: "مزيج من الخضار الورقية الطازجة مع الأفوكادو وصوص خفيف منعش." }
    ]
  },
  ...
  // ---------------------------------------------------------------
  {
    ...
    items: [
      ...
      { name: "بطاطا ميكس", price: 18, desc: "مزيج من البطاطا العادية والكرلي وكرات البطاطا، تشكيلة متكاملة." }
    ]
  },

  // ---------------------------------------------------------------
  // المكاشات (وجبات عائلية) — served as a plate, no bread/wrap
  // ---------------------------------------------------------------
  {
    id: "cat-majash",
    category: "المكاشات (وجبات عائلية)",
    nameEn: "Family Meals",
    image: "assets/categories/majash.jpg",
    layout: "cards",
    items: [
      { name: "ماجاش كبير شنيتسل", price: 40, desc: "شنيتسل مقرمش يُقدَّم مع خضار وصوصات في وجبة عائلية كبيرة." },
      { name: "ماجاش كبير مسحب", price: 40, desc: "دجاج مسحب متبل يُقدَّم مع خضار وصوصات في وجبة عائلية كبيرة." },
      { name: "ماجناش برجيت", price: 40, desc: "شاورما برجيت الدجاج تُقدَّم مع خضار وصوصات في وجبة عائلية كبيرة." }
    ]
  },
  ...
  // ---------------------------------------------------------------
  {
    ...
    layout: "cards",
    items: [
      { name: "وجبة برجيت شاورما", price: 25, desc: "شاورما برجيت الدجاج بالتتبيلة الخاصة تقدم مع سلطة." },
      { name: "وجبة مسحب دجاج", price: 25, desc: "دجاج مسحب متبل يقدم مع سلطة جانبية." },
      { name: "وجبة سجق", price: 30, desc: "سجق مشوي متبل يقدم مع سلطة جانبية." },
      { name: "شنيتسل بكل الأنواع", price: 25, desc: "شنيتسل دجاج مقرمش بنكهتك المفضلة يقدم مع سلطة." },
      { name: "وجبة ستيك دجاج", price: 25, desc: "شرائح صدر دجاج مشوية على القريل تقدم مع سلطة." }
    ]
  },
