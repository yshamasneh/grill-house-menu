...
const menuData = [
  ...
  // ---------------------------------------------------------------
  {
    ...
    layout: "cards",
    items: [
      { name: "برجر كرسبي جاج", price: 20, desc: "قطعة دجاج مقرمشة مع خس طازج وصوص خاص في خبز طري." },
  ...
  // ---------------------------------------------------------------
  {
    ...
    layout: "cards",
    items: [
      { name: "باجيت شنيتسل عادي", price: 15, desc: "شنيتسل دجاج مقرمش كلاسيكي داخل خبز باجيت طازج." },
      { name: "باجيت شنيتسل بزعتر", price: 15, desc: "شنيتسل مقرمش بنكهة الزعتر البلدي داخل باجيت." },
      { name: "باجيت شنيتسل حار", price: 15, desc: "شنيتسل مقرمش مع صوص حار مميز داخل باجيت." },
      { name: "باجيت برجيت", price: 15, desc: "شاورما دجاج بالتتبيلة الخاصة داخل خبز باجيت طازج." },
      { name: "باجيت مسحب", price: 15, desc: "دجاج مسحب متبل مع صوص الثوم والخضار داخل باجيت." },
      { name: "باجيت ستيك جاج", price: 15, desc: "شرائح صدر دجاج مشوية على الفحم مع خضار طازجة." }
    ]
  },
  ...
  // ---------------------------------------------------------------
  // المشروبات — Drinks (compact row, no descriptions)
  // ---------------------------------------------------------------
  {
    id: "cat-drinks",
    category: "المشروبات",
